...
axs = [Axis(fig[1, i], xlabel="x", ylabel="y", title=titles[i], aspect=1, backgroundcolor=:black) for i in 1:3]

# %%
[streamplot!(axs[i], functions[i], -4 .. 4, -4 .. 4, colormap=Reverse(cmaps[i]), gridsize=(32, 32), arrow_size=10) for i in 1:3]
